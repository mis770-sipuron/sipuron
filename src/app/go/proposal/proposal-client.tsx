...
const ALL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "דשבורד אוטומטי עם כל הנתונים מיום 1: הכנסות מ-Cardcom, כניסות מהבוט, גדלי קבוצות מ-Green API. התראות על כשלי אשראי, נטישה, ו-מבצעי השיתופים שנעצר. כל בוקר ב-08:00 — סיכום יומי נשלח לקבוצת WhatsApp ייעודית דרך Green API.",
  ...
  // ── Growth ──
  {
    ...
    subtitle: "ה-מבצעי השיתופים עומד כבר 6 שבועות. בוא נתניע.",
    ...
    impact: "500-2,000 משפחות חדשות", replaces: "מבצעי השיתופים עומד",
  },
  {
    id: "bot",
  ...
  },
  {
    ...
    description: "לוח שנה שנתי שמתואם לחגים יהודיים (חופש גדול, תשרי, חנוכה, פורים). תבנית מוכנה לכל סוג קמפיין. התראות אוטומטיות: קבוצה בשלה? מזכיר. אין קמפיין מתוכנן? מזכיר.",
  ...
  {
    id: "onboarding",
    name: "הודעות כניסה למנוי חדש",
    subtitle: "במקום הודעה ארוכה אחת — סדרת הודעות קצרות שבונות חיבור.",
  ...
  },
  {
    ...
    description: "כל ילד של מנוי מקבל ברכת יום הולדת אישית: הקלטה מיוחדת ממנחם + הפתעה. הורים משתפים את זה מעצמם. אפשרות לשירות בתשלום.",
    whyNow: "הנתונים קיימים — רק צריך לבנות את האוטומציה. השקעה קטנה, תוצאה גדולה.",
  ...
  },
  {
    ...
    description: "פתיחת 2 קבוצות היכרות בשפות חדשות. תרגום/הקלטה של סיפורים נבחרים. דף נחיתה בשפה. אותו מבצעי השיתופים — שוק חדש.",
  ...
  // ── Impact ──
  {
    ...
    originalPrice: 2300, weeks: 2, icon: Heart, category: "impact",
...
const ROADMAP = [
  {
    ...
    emoji: "🔥",
    items: [
      { name: "קמפיין כרטיס טיסה — להתניע את ה-מבצעי השיתופים", status: "ready" as const },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "הכנסה מהקהילה החינמית — שיתופי פעולה עם עסקים", status: "future" as const },
    ],
  },
]
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div className="rounded-2xl border bg-card p-6 shadow-sm">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-2">
                <CheckCircle className="h-4 w-4 text-emerald-500 flex-shrink-0 mt-0.5" />
                <span>מבצעי השיתופים מוכח שעובד כל פעם מחדש</span>
              </li>
              <li className="flex gap-2">
                <CheckCircle className="h-4 w-4 text-emerald-500 flex-shrink-0 mt-0.5" />
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-sm">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex gap-2">
                <span className="text-red-500 flex-shrink-0 mt-0.5">●</span>
                <span>אפריל: <strong>5 כניסות לבוט ביום</strong> — ה-מבצעי השיתופים עומד</span>
              </li>
              <li className="flex gap-2">
                <span className="text-red-500 flex-shrink-0 mt-0.5">●</span>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border-2 border-red-200 dark:border-red-800/30 bg-red-50/50 dark:bg-red-950/10 p-6 shadow-sm">
            ...
            <ul className="space-y-3 text-sm">
              {[
                "מבצעי השיתופים קפוא — 5 כניסות ביום",
